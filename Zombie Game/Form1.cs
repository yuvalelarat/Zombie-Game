...
namespace Zombie_Game
{
    public partial class ZombieGame : Form
    {
        ...
        SoundPlayer GameStartSound = new SoundPlayer("GameStartSound.wav");
        SoundPlayer GunShot = new SoundPlayer("Gunshot.wav");
        SoundPlayer Reload = new SoundPlayer("Reload.wav");
        SoundPlayer Healing = new SoundPlayer("Healing.wav");
        SoundPlayer TrapSound = new SoundPlayer("TrapSound.wav");
        ...
        private void GameOver()
        {
            ...
            {
                HighScore = kills;
                MostKills.Text = "High score: " + HighScore;
                MostKills.ForeColor = Color.Maroon;
                MostKills.TextAlign = ContentAlignment.MiddleCenter;
            }
            if (msg == false)
            {
                msg = true;
